      ...
      <div className="jj">
        ...
        >
          <div style={{ marginLeft: "20%", marginRight: "20%" }}>
            ...
            <p style={{ textAlign: "left" }}>
              Our Surgical Services department offers a wide
              range of essential surgical procedures aimed at addressing common
              medical conditions and injuries. We specialize in both elective
              and emergency surgeries, ensuring that patients receive the
              appropriate care for their needs. From minimally invasive
              procedures to more traditional surgeries, we utilize the latest
              techniques and equipment to achieve optimal outcomes with minimal
              recovery time. Our team of skilled surgeons is highly trained in
              performing various types of surgeries, including gallbladder
              removal, appendectomy, hernia repairs, and more. Patient safety is
              our highest priority, and our surgical team follows stringent
